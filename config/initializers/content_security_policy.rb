...
Rails.application.config.content_security_policy do |p|
  ...
  p.style_src       :self, assets_host, :unsafe_inline # FIXME
  ...
  if Rails.env.development?
    ...
    p.connect_src :self, :data, :blob, assets_host, media_host, Rails.configuration.x.streaming_api_base_url, *vite_urls
